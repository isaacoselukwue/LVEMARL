...
try:
    ...
    LAYER_BACKGROUND = pyglet.graphics.Group(order=0)
    LAYER_FOREGROUND = pyglet.graphics.Group(order=1)
    LAYER_TOP = pyglet.graphics.Group(order=2)
except Exception as error:
    print("Import error! You will not be able to render --> %s" % error)
...
class Viewer(object):
    ''' Base class for the graphics module.
        Used to share common functionality between the differentf
        rendering engines.
     '''
    def __init__(self):
        self.window = None
